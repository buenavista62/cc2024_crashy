...
uploaded_file = st.file_uploader("Bitte laden Sie ein "
    "Bild vom Schaden hoch", type=["jpg", "jpeg", "png"])
...
if uploaded_file is not None:
    ...
    if not final_resp.car_present:
        st.write("Das Auto ist nicht sichtbar. Bitte laden Sie ein Bild vom gesamten Fahrzeug hoch.")
    if not final_resp.damage_recognized:
        st.write("Kein Schaden erkannt. Bitte laden Sie ein Bild mit sichtbarem Schaden hoch.")
    if not final_resp.damage_fully_visible:
        st.write("Schaden nicht vollständig sichtbar. Bitte laden Sie ein Bild mit vollständig sichtbarem Schaden hoch.")
